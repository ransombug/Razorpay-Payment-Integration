...
namespace Yuvraj_Payment_integration.Controllers
{
    public class PaymentController : Controller
    {
        ...
        public ActionResult CreateOrder(Models.PaymentInitiateModel _requestData)
        {
            ...
            Razorpay.Api.RazorpayClient client = new Razorpay.Api.RazorpayClient("rzp_test_hxpR5cGSEsJtHI", "ygBYYzizxnzhjrq8PJ9gzIwY");
            ...
            OrderModel orderModel = new OrderModel
            {
                ...
                razorpayKey = "rzp_test_hxpR5cGSEsJtHI",
